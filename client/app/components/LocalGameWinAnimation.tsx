...
export default function LocalGameWinAnimation({
	winnerName,
	winnerImg,
	message = "Returning to games...",
}: LocalGameWinAnimationProps) {
	return (
		<div className="bg-gray-400/30 backdrop-blur-sm flex flex-col justify-center items-center z-50 absolute top-0 bottom-0 left-0 right-0">
			<div className="text-center">
				...
				<div className="flex justify-center items-center gap-4 mb-6">
					<div className="rounded-full w-24 h-24 overflow-hidden border-4 border-yellow-400">
						<img
							src={winnerImg}
							alt="winner"

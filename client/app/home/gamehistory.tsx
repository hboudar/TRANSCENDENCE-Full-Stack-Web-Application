...
export default function GameHistory({ user, games }) {
    return (
        <div className="flex-1/2 min-h-[400px] max-h-[500px] bg-[#2b24423d] rounded-xl flex flex-col gap-2 border border-[#7b5ddf3d] shadow-[0_0_10px_#7b5ddf22] backdrop-blur-sm ">

...
const items: Item[] = [
  { id: 1, name: "table1", image: "/table1.png", price: 500 },
  { id: 2, name: "table2", image: "/table2.png", price: 500 },
  { id: 3, name: "table3", image: "/table3.png", price: 500 },
  { id: 4, name: "table4", image: "/table4.png", price: 500 },
];
      ...
      <div className="flex space-x-4 overflow-x-auto pb-4 md:flex-col md:space-x-0 md:space-y-4 md:w-1/3">
        {items.map((item) => (
          <div
            ...
            className={`flex-shrink-0 w-40 p-4 border rounded-lg cursor-pointer hover:shadow-lg flex flex-col items-center
